...
import ru.vktracker.feature.account.users.tabs.subscribers.di.AccountSubscribersModule.Companion.COMMUNICATION_NAME
import ru.vktracker.feature.account.users.tabs.subscribers.di.AccountSubscribersModule.Companion.HANDLE_REQUEST_NAME
import ru.vktracker.feature.account.users.tabs.subscribers.di.AccountSubscribersModule.Companion.INTERACTOR_NAME
 ...
 */
@HiltViewModel
class AccountSubscribersTabViewModel @Inject constructor(
